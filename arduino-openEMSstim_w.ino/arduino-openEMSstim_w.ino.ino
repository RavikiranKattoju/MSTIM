...
void doCommand(String str) {
   ...
   //digitalPot.setPosition(1, 40);
	
		//printer(buffer + String(digitalPot.getPosition(1))); //"\tEMS: Intensity Channel 1: "
 printer("EMS:"+String(digitalPot.getPosition(1)));
	} else if (c == 's') {
